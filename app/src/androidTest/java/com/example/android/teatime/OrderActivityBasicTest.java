...
//uses androidjunit4 class which helps control running and testing the app
@RunWith(AndroidJUnit4.class)
public class OrderActivityBasicTest {
    //ActivityTestRule to specify what activity we will be testing
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        ...
        //check that views do not decrease beyond zero
