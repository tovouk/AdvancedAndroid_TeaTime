...
public class OrderSummaryActivityTest {
    ...
    @Rule public IntentsTestRule<OrderSummaryActivity> intentsTestRule = new IntentsTestRule<>(OrderSummaryActivity.class);

    //must match email_message string value like in OrderSummaryActivity
